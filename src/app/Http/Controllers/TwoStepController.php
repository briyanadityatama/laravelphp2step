...
namespace briyanadityatama\laravelphp2step\App\Http\Controllers;
...
class TwoStepController extends Controller
{
    ...
    private function setUser2StepData()
    {
        ...
        $this->_remainingAttempts = config('laravelphp2step.laravelphp2stepExceededCount') - $authCount;
    }
    ...
    private function invalidCodeReturnData($errors = null)
    {
        ...
        $returnData = [
            'message'           => trans('laravelphp2step::laravel-verification.titleFailed'),
    ...
    public function showVerification()
    {
        ...
        if ($this->_authCount > config('laravelphp2step.laravelphp2stepExceededCount')) {
            ...
            return View('laravelphp2step::twostep.exceeded')->with($data);
        }
        ...
        if (!$sentTimestamp) {
            ...
            $timeBuffer = config('laravelphp2step.laravelphp2stepTimeResetBufferSeconds');
        ...
        return View('laravelphp2step::twostep.verification')->with($data);
    }
    ...
    public function verify(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $returnData = [
                ...
                'message' => trans('laravelphp2step::laravel-verification.titlePassed'),
            ];
    ...
    public function resend()
    {
        ...
        $returnData = [
            'title'   => trans('laravelphp2step::laravel-verification.verificationEmailSuccess'),
            'message' => trans('laravelphp2step::laravel-verification.verificationEmailSentMsg'),
        ];
